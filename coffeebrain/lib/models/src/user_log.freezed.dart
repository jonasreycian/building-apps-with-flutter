...
abstract class $UserLogCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, Activity activity, DateTime created, String userId});
}
...
class _$UserLogImpl implements _UserLog {
  ...
  @override
  String toString() {
    return 'UserLog(id: $id, activity: $activity, created: $created, userId: $userId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, activity, created, userId);
...
abstract class _UserLog implements UserLog {
  const factory _UserLog(
      ...
      required final String userId}) = _$UserLogImpl;

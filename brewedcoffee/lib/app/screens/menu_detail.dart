...
class _MenuDetailsState extends State<MenuDetails> {
  ...
  int quantity = 1;
  CoffeeCupSizeEnum size = CoffeeCupSizeEnum.medium;
  SugarCubeEnum sugar = SugarCubeEnum.no;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CoffeeSize(
                          onPressed: (CoffeeCupSizeEnum cupSize) {
                            setState(() {
                              size = cupSize;
                            });
                          },
                        ...
                        CoffeeSugar(
                          sugar: sugar,
                          onPressed: (SugarCubeEnum sugarSize) {
                            setState(() {
                              sugar = sugarSize;
                            });
                          },
  ...
  num total(num price) => getCartItemTotal(
        count: quantity,
        price: price,

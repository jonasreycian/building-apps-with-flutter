...
mixin _$FirestoreUser {
  List<UserRoleEnum> get roles => throw _privateConstructorUsedError;
...
abstract class $FirestoreUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserRoleEnum> roles});
}
...
class _$FirestoreUserImpl extends _FirestoreUser {
  const _$FirestoreUserImpl({required final List<UserRoleEnum> roles})
      : _roles = roles,
        super._();
  ...
  final List<UserRoleEnum> _roles;
  @override
  List<UserRoleEnum> get roles {
...
abstract class _FirestoreUser extends FirestoreUser {
  const factory _FirestoreUser({required final List<UserRoleEnum> roles}) =
      _$FirestoreUserImpl;
